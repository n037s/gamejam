...
public class Ressources_collector : NetworkBehaviour
{
    ...
    void Start()
    {
        ...
        if (playerManagerRef.isCurrentPlayer)
        {
            ...
            if (Panneau != null)
            {
                ...
                {
                    resourcePanelController_instance.OnPrefabCreated(this);
    ...
    //private void OnCollisionEnter(Collision collision)
    {
        ...
        {
            compteur_bois++;
            DespawnResourceServerRpc(objetTouche.GetComponent<NetworkObject>());
    ...
    void DespawnResourceServerRpc(NetworkObjectReference networkObjectRef)
    {
